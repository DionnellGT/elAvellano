      ...
      <div className="max-w-7xl mx-auto px-6 py-9 mb-7">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[420px] md:h-[480px]">
            ...
            <div className="absolute inset-0 flex items-center justify-start pl-0 -translate-x-16">
              <div className="w-[55%] rounded-2xl overflow-hidden shadow-xl border-4 border-white">
                <img
                  src="/home_1.jpg"
